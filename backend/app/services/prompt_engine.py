...
_EVIDENCE_TIER_RULE = (
    ...
    "- Set `loe` from the tier: Tier A/B -> I, Tier C -> II, **Tier T -> II**, Tier D -> III, "
    "Tier R -> III. Set `confidence` accordingly: high only for Tier A/B, moderate for C and T, "
    "low for D/R. Every tier has an loe — do not leave one to judgement.\n"
