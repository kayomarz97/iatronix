...
## Goal
Bring both environments live on the VPS (REDACTED_HOST_IP):
- **Production**: med.kayomarz.com → ports 3200/8200, docker-compose.prod.yml
- **Development**: med.kayomarz.com → ports 3201/8201, docker-compose.dev.yml
...
Dev compose needs .env.dev. Verify it exists and has correct values:
  ...
  - ALLOWED_ORIGINS=https://med.kayomarz.com,...
