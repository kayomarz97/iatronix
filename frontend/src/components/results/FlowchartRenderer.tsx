...
// ── Palette ───────────────────────────────────────────────────────────────────
// Neutral surfaces + accent/semantic borders & labels, all theme tokens (light + dark safe).
const C = {
  start:    { bg: "var(--bg-elevated)", border: "var(--accent)",      text: "var(--text-primary)", label: "var(--accent)" },
  end:      { bg: "var(--bg-elevated)", border: "var(--sec-monitor)", text: "var(--text-primary)", label: "var(--sec-monitor)" },
  action:   { bg: "var(--bg-surface)",  border: "var(--border)",      text: "var(--text-primary)", label: "var(--sec-proc)" },
  decision: { bg: "var(--bg-elevated)", border: "var(--sec-adv)",     text: "var(--text-primary)", label: "var(--sec-adv)" },
  branch:   ["var(--sec-ind)", "var(--sec-adv)", "var(--sec-contra)", "var(--sec-mech)", "var(--sec-dose)"],
};
