...
The loop checks all invariants below on med.kayomarz.com (dev) and iterates until three
...
(med.kayomarz.com) until ALL of them pass green for three consecutive runs:
...
On each iteration:
  ...
  - Run /cso daily mode
  - Run /benchmark
  - Run /qa-only standard tier on med.kayomarz.com
